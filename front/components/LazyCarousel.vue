<template>
    <div class="carousel-wrapper">
        ...
        <Carousel ref="myCarousel" :wrap-around="true" :items-to-show="1" :breakpoints="state.breakpoints"
            :autoplay="5000" :transition="1000" @before-init="handleBeforeInit" @slide-start="handleSlideStart"
            @slide-end="handleSlideEnd" :mouseDrag="false">
            <Slide :class="{ 'trees-slide': props.treesCarousel }" v-for="(value, index) in state.currentPictures"
                :key="index">
                <div class="slider-img">
                    <img class="picture-logos" :class="{ 'picture-trees': props.treesCarousel }" :src="value[0]" />
