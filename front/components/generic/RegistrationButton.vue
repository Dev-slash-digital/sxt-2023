<template>
    <a @click="handleClick" :class="props.invertDisplayBehavior
            ? 'button-container-inverted-behavior'
            : 'button-container'
        ">
